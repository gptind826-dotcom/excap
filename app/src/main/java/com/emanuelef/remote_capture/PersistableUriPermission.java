...
// If an app asks to dump to a PCAP file, ensure that eXcap has such a permission.
...
public class PersistableUriPermission {
    ...
    private void pcapFileResult(final ActivityResult result) {
        if (result.getResultCode() == Activity.RESULT_OK && result.getData() != null) {
             ...
             * This is needed to write to the URI when invoking eXcap from other apps via Intents
