    ...
    public @NonNull MatchList getList() {
        switch(mType) {
            case VISUALIZATION_MASK:
                return ExcapApp.getInstance().getVisualizationMask();
            case MALWARE_WHITELIST:
                return ExcapApp.getInstance().getMalwareWhitelist();
            case BLOCKLIST:
                return ExcapApp.getInstance().getBlocklist();
            case FIREWALL_WHITELIST:
                return ExcapApp.getInstance().getFirewallWhitelist();
            case DECRYPTION_LIST:
                return ExcapApp.getInstance().getDecryptionList();
        }
