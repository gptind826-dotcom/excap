...
public class ConnectionsFragment extends Fragment implements ConnectionsListener, MenuProvider, SearchView.OnQueryTextListener {
    ...
    public void onCreateContextMenu(@NonNull ContextMenu menu, @NonNull View v,
        ...
        MatchList fwWhitelist = ExcapApp.getInstance().getFirewallWhitelist();
        MatchList decryptionList = ExcapApp.getInstance().getDecryptionList();
    ...
    public boolean onContextItemSelected(@NonNull MenuItem item) {
        Context ctx = requireContext();
        ConnectionDescriptor conn = mAdapter.getSelectedItem();
        MatchList whitelist = ExcapApp.getInstance().getMalwareWhitelist();
        MatchList fwWhitelist = ExcapApp.getInstance().getFirewallWhitelist();
        MatchList decryptionList = ExcapApp.getInstance().getDecryptionList();
        Blocklist blocklist = ExcapApp.getInstance().getBlocklist();
