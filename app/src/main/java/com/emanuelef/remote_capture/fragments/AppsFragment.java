...
public class AppsFragment extends Fragment implements ConnectionsListener, MenuProvider {
    ...
    public void onCreateContextMenu(@NonNull ContextMenu menu, @NonNull View v,
        ...
        boolean isBlocked = ExcapApp.getInstance().getBlocklist().matchesApp(stats.getUid());
        menu.findItem(R.id.block_app).setVisible(!isBlocked);

        if(Prefs.isFirewallWhitelistMode(prefs)) {
            boolean isWhitelisted = ExcapApp.getInstance().getFirewallWhitelist().matchesApp(stats.getUid());
    ...
    public boolean onContextItemSelected(@NonNull MenuItem item) {
        ...
        MatchList whitelist = ExcapApp.getInstance().getFirewallWhitelist();
