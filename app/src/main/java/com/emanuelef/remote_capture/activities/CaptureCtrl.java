...
public class CaptureCtrl extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mPermissions = ExcapApp.getInstance().getCtrlPermissions();
    ...
    private void processRequest(Intent req_intent, @NonNull String action) {
        ...
        if(action.equals(ACTION_START)) {
            ...
            ExcapApp.getInstance().setIsDecryptingPcap(false);
    ...
    // A request sent from a debug build of eXcap to a non-debug one
