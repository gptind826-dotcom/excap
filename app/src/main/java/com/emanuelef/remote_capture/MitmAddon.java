...
public class MitmAddon {
    ...
    public static final String REPOSITORY = "https://github.com/emanuele-f/eXcap-mitm";
    ...
    public static String getGithubReleaseUrl(String version) {
        return REPOSITORY + "/releases/download/v" +
                version + "/eXcap-mitm_v" + version + "_" + Build.SUPPORTED_ABIS[0] + ".apk";
    }
    ...
    // NOTE: doze could be disabled by eXcap itself, however this is moved to the addon to avoid
